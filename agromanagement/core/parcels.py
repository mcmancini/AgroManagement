...
from agromanagement.core import app_config
from agromanagement.core.utils import get_dtm_values, lonlat2osgrid
...
class Parcel:
    ...
    _PARCEL_DATA_PATH = app_config.data_dirs["parcel_dir"]
    ...
    def _calc_spatial_attributes(self):
        ...
        """
        parcels_shapefile = gpd.read_file(self._PARCEL_DATA_PATH)
